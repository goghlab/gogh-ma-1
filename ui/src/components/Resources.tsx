    ...
    <div data-test-id="resources" className="flex space-x-3 overflow-x-auto">
      {resources.map((resource, idx) => (
        <Card
          ...
          key={idx}
          className={
            "bg-[#2e2e32] border-0 shadow-none rounded-xl text-md font-extralight focus-visible:ring-0 flex-none" +
          ...
          <CardContent className="px-6 py-6 relative">
            <div className="flex items-start space-x-3 text-sm">
              <div className="flex-grow">
                ...
                <p
                  className="text-base mt-2 text-zinc-300"
                  style={{
                ...
                <a
                  ...
                  className="text-sm hover:underline mt-3 text-zinc-400 inline-block"
                  title={resource.url}
                  style={{
              ...
              {removeResource && (
                <div className="flex items-start absolute top-4 right-4">
                  ...
                  >
                    <Trash2 className="w-6 h-6 text-zinc-400 hover:text-red-500" />
                  </Button>
                </div>
              )}
            </div>
